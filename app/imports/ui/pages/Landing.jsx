    ...
    return (
        ...
        <Grid container stackable centered columns ={3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as ='h3' inverted>This address book enables any number of users to login and save their business contacts. You can only  see the contacts you have </Header>
          </Grid.Column>
